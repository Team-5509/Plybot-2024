...
public class HaloDrive extends Command{
    ...
    public void execute() {
        ...
        boolean halfFinesseMode = RobotContainer.getInstance().getDriverController().getRawButton(5);
        boolean thirdFinesseMode = RobotContainer.getInstance().getDriverController().getRawButton(6);
        double deadband = .2;
        ...
        m_drivetrain.drive(.25 * finnesseValue*x, .25 * finnesseValue*y, .25 * finnesseValue*rotation);
